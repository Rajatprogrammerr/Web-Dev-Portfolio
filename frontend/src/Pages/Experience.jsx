    ...
    <div className="w-screen overflow-x-hidden md:mt-16 mt-24 ">
      <div className="flex justify-center items-center">
        ...
        <div className="flex lg:flex-row md:flex-col flex-col  justify-center items-center gap-4" ref={textRef}>
          <div className="flex justify-center items-center">
            <img ref={el => letterRefs.current[0] = el} className="sm:size-32 md:size-44 size-10" src={e} alt="A" />
          ...
          <div className="flex justify-center items-center">
            <img ref={el => letterRefs.current[9] = el} className="sm:size-28 md:size-36 size-8" src={E} alt="M" />
            <img ref={el => letterRefs.current[10] = el} className="sm:size-12 md:size-16 size-8" src={x} alt="E" />
            <img ref={el => letterRefs.current[11] = el} className="sm:size-12 md:size-16 size-8" src={p} alt="P" />
            <img ref={el => letterRefs.current[12] = el} className="sm:size-12 md:size-16 size-8" src={e} alt="P" />
            <img ref={el => letterRefs.current[13] = el} className="sm:size-12 md:size-16 size-8" src={r} alt="P" />
            <img ref={el => letterRefs.current[14] = el} className="sm:size-12 md:size-16 size-8" src={i} alt="P" />
            <img ref={el => letterRefs.current[15] = el} className="sm:size-12 md:size-16 size-8" src={E} alt="P" />
            <img ref={el => letterRefs.current[16] = el} className="sm:size-12 md:size-16 size-8" src={n} alt="P" />
            <img ref={el => letterRefs.current[17] = el} className="sm:size-12 md:size-16 size-8" src={c} alt="P" />
            <img ref={el => letterRefs.current[18] = el} className="sm:size-12 md:size-16 size-8" src={e} alt="P" />
          </div>
        </div>
      </div>
